...
interface LoanLimitAdaptor {
     ...
     *
     * @param requestParam   공통 요청 DTO
     * @return  공통 응답 DTO (성공/실패 여부 포함)
     */
    fun inquireLimit(partnerCode: PartnerCode, requestParam: LoanLimitAdaptorRequest): LoanLimitAdaptorResponse
}
