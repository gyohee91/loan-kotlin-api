...
@Component
class PersonalLoanLimitStrategy(
    private val partnerLoanTypeRepository: PartnerLoanTypeRepository
) : LoanLimitStrategy {

    override val loanType: LoanType = LoanType.PERSONAL_CREDIT
    ...
    override fun fetchExternalData(request: LoanLimitRequest): ExternalDataContext = empty()
